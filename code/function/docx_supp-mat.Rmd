...
**Supplementary Table `r tbl_counter`.** Comparison of human population living within 20 km from coral reefs across the 53 GCRMN subregions and associated regions.
...
figure_path <- "../../figs/06_supp-mat/raw-average_a.png"
...
**Supplementary Figure `r fig_counter`.** Annual means of observed data (*i.e.* monitoring data) for hard coral and macroalgae cover across five out of ten GCRMN region (Australia, Brazil, Caribbean, East Asian Seas, and Eastern Tropical Pacific) from 1980 to 2024. Grey dots in the background represent the mean values of individual transects conducted each year.
...
figure_path <- "../../figs/06_supp-mat/raw-average_b.png"
...
**Supplementary Figure `r fig_counter`.** Annual means of observed data (*i.e.* monitoring data) for hard coral and macroalgae cover across five out of ten GCRMN region (Pacific, PERSGA, ROPME, South Asia, Western Indian Ocean) from 1980 to 2024. Grey dots in the background represent the mean values of individual transects conducted each year.
...
**Supplementary Table `r tbl_counter`.** Comparison of benthic cover monitoring indicators across the 53 GCRMN subregions and associated regions.
...
**Supplementary Figure `r fig_counter`.** Comparison of the percentage of sites per number of years with monitoring data across the 10 GCRMN regions.
...
**Supplementary Table `r tbl_counter`.** List of individual datasets used to estimate benthic cover trends in hard coral and macroalgae cover in the 10 GCRMN regions.
